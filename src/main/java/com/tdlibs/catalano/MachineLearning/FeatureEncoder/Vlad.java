...
import com.tdlibs.catalano.MachineLearning.FeatureScaling.VectorNormalization;
        ...
        for (int f = 0; f < features.length; f++) {
            ...
            if(softmax){
                ...
                for (int j = 0; j < centroids.length; j++) {
                    dist[j] = com.tdlibs.catalano.Math.Distances.Distance.Euclidean(features[f], centroids[j]);
                }
