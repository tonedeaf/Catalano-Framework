...
package com.tdlibs.catalano.MachineLearning.Regression.RegressionTrees.Learning;
...
import com.tdlibs.catalano.MachineLearning.Regression.RegressionTrees.RegressionTree;
...
public class GradientBoostingTree implements IRegression, Serializable{
    ...
    public void Learn(double[][] input, double[] output) {
        ...
        if (loss == Loss.LeastSquares) {
            response = residual;
            b = com.tdlibs.catalano.Statistics.Tools.Mean(output);
            for (int i = 0; i < n; i++) {
            ...
            b = com.tdlibs.catalano.Statistics.DescriptiveStatistics.Median(residual);
    ...
    class LADNodeOutput implements RegressionTree.NodeOutput {
        ...
        public double calculate(int[] samples) {
            ...
            return com.tdlibs.catalano.Statistics.DescriptiveStatistics.Median(r);
        }        
    }
    ...
    class HuberNodeOutput implements RegressionTree.NodeOutput {
        ...
        public double calculate(int[] samples) {
            ...
            double r = com.tdlibs.catalano.Statistics.DescriptiveStatistics.Median(res);
            double output = 0.0;
