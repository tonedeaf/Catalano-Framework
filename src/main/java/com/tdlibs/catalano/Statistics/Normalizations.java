...
//
package com.tdlibs.catalano.Statistics;
...
public class Normalizations {
    ...
    public static double[] StandartNormalDensity(double[] data){
        double[] norm = new double[data.length];
        double mean = com.tdlibs.catalano.Statistics.DescriptiveStatistics.Mean(data);
        double stdDev = com.tdlibs.catalano.Statistics.DescriptiveStatistics.StandartDeviation(data);
    ...
    public static double[] MinMaxNormalization(double[] data, double min, double max){
        ...
        double[] norm = new double[data.length];
        double fMin = com.tdlibs.catalano.Statistics.DescriptiveStatistics.Minimum(data);
        double fMax = com.tdlibs.catalano.Statistics.DescriptiveStatistics.Maximum(data);
