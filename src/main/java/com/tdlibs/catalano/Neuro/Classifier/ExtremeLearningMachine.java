...
package com.tdlibs.catalano.Neuro.Classifier;
...
import com.tdlibs.catalano.Neuro.ActivationFunction.IActivationFunction;
import com.tdlibs.catalano.Neuro.ActivationFunction.SigmoidFunction;
...
public class ExtremeLearningMachine implements IClassifier, Serializable{
    ...
    public void Learn(double[][] input, int[] output) {
        ...
        int[] uniques = com.tdlibs.catalano.Math.Tools.Unique(output);
        Arrays.sort(output);
